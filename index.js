var Portfolio = /** @class */ (function () {
    ...
    Portfolio.prototype.addProjectsSection = function () {
        ...
        var card1 = createCard('Nexa', 'Decentralized messaging service.', "<span class='keyword'>from</span> <span class='function'>Nexa</span> <span class='keyword'>import</span> <span class='function'>initService</span>\n</span>messaging = <span class='function'>initService</span>(<span class='string'>'Nexa'</span>)", "Developed in Python with a team of four. GitHub: <a href='https://github.com/val-005/Nexa'>Nexa</a>");
        var card2 = createCard('Test Blockchain in Python', 'Creating a simple blockchain.', "<span class='keyword'>def</span> <span class='function'>create_blockchain</span>():\n    <span class='keyword'>return</span> [<span class='string'>'genesis block'</span>]", "Developed solo in Python. GitHub: <a href='https://github.com/0xZKnw/Bc_Test'>Bc_Test</a>");
        var card3 = createCard('0xZKnw.me', 'This Website', "<span class='keyword'>import</span> axios;\naxios.<span class='function'>get</span>(<span class='string'>'https://0xZKnw.me'</span>);", "Developed solo in TypeScript. GitHub: <a href='https://github.com/0xZKnw/0xzknw.fr'>0xZKnw.me</a>");
        var card4 = createCard('Old Portfolio', 'My old portfolio.', "<<span class='keyword'>head</span>>\n      <<span class='keyword'>title</span>><span class=\"string\">old.0xZKnw.me</span><<span class='keyword'>/title</span>>\n<<span class=\"keyword\">/head</span>>", 'My old portfolio, built exclusively with HTML and CSS. Site : <a href="https://old-0xzknw.netlify.app">Old Portfolio</a>');
